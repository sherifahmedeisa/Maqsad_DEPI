...
function PrivateRoute({ children }) {
  ...
  return user ? children : <Navigate to="/provider-login" replace />;
}
    ...
    <div className={`${isProvider ? "" : "flex flex-col min-h-screen"} bg-background`}>
      ...
      <main className={isProvider ? "" : "flex-grow"}>
        <Routes>
          ...
          {/* Guest / Public Routes */}
          <Route path="/provider-login" element={<PublicRoute><ProviderLogin /></PublicRoute>} />
          <Route path="/beneficiary-login" element={<PublicRoute><BeneficiaryLogin /></PublicRoute>} />
