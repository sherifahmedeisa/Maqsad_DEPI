      ...
      <div className="row h-100 ">
        ...
        >
          <div className="login-card">
            ...
            <h2 className="mt-4 fw-bold">Create your client account</h2>
            <p className="text-secondary mb-4">
              Access top-tier service providers for your enterprise needs.
            </p>
            <form className="border rounded-4 shadow-sm bg-white p-4">
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  <label className="form-label fw-semibold">
                    Organization Name<span className="text-info">*</span>
                  </label>
                  <div className="position-relative">
                    <span className="material-symbols-outlined input-icon2">
                      apartment
