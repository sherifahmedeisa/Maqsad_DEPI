      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 bg-[#f8fafc]">
        <div className="w-full max-w-[450px] flex flex-col gap-lg">
          ...
          <div className="flex flex-col gap-xs">
            ...
            <h2 className="text-3xl text-on-surface font-bold mt-4">Create Provider Account</h2>
            <p className="text-slate-500 font-body-md">Register your enterprise details to begin applying for RFPs.</p>
          </div>
