    ...
    <div className="flex-grow w-full max-w-container-max mx-auto px-margin-mobile md:px-lg py-xl flex flex-col gap-xl">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-md">
        <div>
          ...
          <p className="font-body-md text-body-md text-on-surface-variant">
            Discover professional services posted by qualified providers.
          </p>
        </div>
        <div className="flex items-center gap-sm">
          <div className="relative">
            ...
            <input
              className="pl-10 pr-4 py-2 bg-surface border border-outline-variant rounded-lg font-body-sm text-body-sm focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary w-full md:w-72 transition-shadow"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg">
        ...
        <aside className="lg:col-span-3">
          <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg shadow-sm sticky top-20">
            <h3 className="font-headline-sm text-headline-sm text-on-surface mb-md">Filters</h3>
            ...
            <div className="mb-lg">
              ...
              <div className="flex flex-col gap-xs">
                {categories.map((cat) => (
                  <button
                    key={cat}
                    className={`text-left px-md py-sm rounded-lg font-body-sm text-body-sm transition-colors ${
            ...
            <div>
              ...
              <select
                className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg px-md py-sm font-body-sm text-body-sm text-on-surface focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-colors"
                value={sortBy}
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-md">
                    <div className="flex-1">
                      <div className="flex items-center gap-sm mb-xs flex-wrap">
                        ...
                        >
                          {rfp.status === "open" ? "Open" : rfp.status}
                        </span>
                      </div>
                      <Link
                        to={`/rfp/${rfp.id}`}
